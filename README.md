# GodnessSensor
This is a practice version based on BossSenor

Reminder when your godness is approaching.


I am keeping all the orginal information in the following.
Some more codes are added for testing 
